...
<body>
    ...
    <form action="bolsillo" method="post">
        ...
        <input type="number" class="formulario"  name="Recarga" placeholder="Cuanto desea recargar?">

        <button class="boton" type="submit" name="accion" value="recarga">Recargar</button>
