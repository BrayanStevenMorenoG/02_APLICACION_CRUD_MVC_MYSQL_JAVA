...
<body>
    ...
    <header class="header">
        <div class="logo">
            <a href= "usuario?accion=index"><img src="assets/img/logo.png" alt="Daviplata logo"></a>
        </div>
    ...
    <nav class="nav">
        <ul class="nav-links">
            <li><a href= "usuario?accion=recargaDaviplata">Recargar</a></li>
            <li><a href= "usuario?accion=retiroDaviplata">Retirar</a></li>
            <li><a href= "usuario?accion=consultarDaviplata">Consultar</a></li>
            <li><a href= "usuario?accion=verUsuDaviplata">Gestionar usuarios</a></li>
            <li><a href= "bolsillo?accion=verBolDaviplata">Gestionar bolsillos</a></li>
        </ul>
    </nav>
