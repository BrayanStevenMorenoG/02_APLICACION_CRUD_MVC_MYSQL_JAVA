...
<body>
    ...
    <header class="header">
        ...
        <h1 class="titulo">USUARIOS DAVIPLATA</h1>
        <a href="#" class="btn"><button>Contacto</button></a>
    </header>
    <nav class="nav">
        <ul class="nav-links">
            <li><a href= "usuario?accion=volverDaviplata">Volver</a></li>
        </ul>
    </nav>
<body>
...
<c:forEach var="usuarios" items="${usuarios}">
    <form method="POST" action="usuario">
            <tr>
                ...
                <td><input class="tablas" type="text" name="cedula" value="${usuarios.getCedula()}"></td>
                <td><input class="tablas" type="password" name="password"  value="${usuarios.getPassword()}"></td>
                <td><button class="tablas" type="submit" name="accion" value="ActualizarUsuDaviplata">Actualizar</button></td>
            </tr>
        </form>
</c:forEach>
</tbody>
