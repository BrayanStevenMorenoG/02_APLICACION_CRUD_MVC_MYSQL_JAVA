...
<body>
    ...
    <nav class="nav">
        <ul class="nav-links">
            <li><a href= "usuario?accion=recargaNequi">Recargar</a></li>
            <li><a href= "usuario?accion=retiroNequi">Retirar</a></li>
            <li><a href= "usuario?accion=consultarNequi">Consultar</a></li>
            <li><a href= "usuario?accion=verUsuNequi">Gestionar usuarios</a></li>
            <li><a href= "bolsillo?accion=verBolNequi">Gestionar bolsillos</a></li>
        </ul>
    </nav>
    <section class="nequi">
